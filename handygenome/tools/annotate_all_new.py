...
def add_annotations(
    ...
    def add_vep_nonsv(
        ...
        # write
        transcript_set_list.write_info(vr)
        regulatory_set.write_info(vr)
        motif_set.write_info(vr)
        repeat_set.write_info(vr)
